...
* load and parse data
* start at the beginning and extract substring of size 4
* extract letters of substring to a set (Sets only have unique items)
* check if size of set is equal to 4
...
* use solution one and adjust package size to 14